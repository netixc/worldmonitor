...
- HealthMap / ProMED RSS (`rssNormalizeItem`)
- TGH (`tghNormalizeItem`)
...
- Pattern reference: [CII risk scoring methodology](./cii-risk-scores.md) (same disclosure pattern, larger scope)
